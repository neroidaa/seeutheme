		...
		<div id="programme-list">
			...
			<?php foreach($departments as $i => $department): ?>
				...
				<?php
					...
					$criterias->addCondition("cycle='Postgraduate' OR cycle='Undergraduate' OR cycle='PhD'");
				...
				<div class="department well well-small" style="background: #fff; border-radius: 0;">
					...
					?>
						...
						<?php
							...
							//$criteria->addCondition("accreditation_date = '2017-08-18'");
							//$criteria->addCondition('accreditation_date > 2016-12-31');
							//$criteria->addCondition("specialization =0", 'OR');
						...
						<?php foreach ($ects as $ectsKey => $ectsName): ?>	
							...
							<?php foreach($programmes as $i => $programme): ?>
								<?php if(($cycleKey == 'Undergraduate' || $cycleKey == 'PhD' ) && empty($programme->code)): ?>
